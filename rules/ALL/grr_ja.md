...
*iHR2024*の一部の競技では，オブジェクトの認識と操作が必要である．
...
これらのオブジェクトは*iHR2024*競技会の数ヶ月前に公開され，事前に取得と学習ができるようになっている．
...
*iHR2024*の一部の競技では，人やオブジェクトが見つかる*Predefined Location*が設定される．
...
*iHR2024*の一部の競技では，人物の名前を記憶する必要がある．
...
## ロボット (Robots)
*iHR2024*で使用されるロボットは，以下の要件を満たす必要がある．
...
*iHR2024*に参加するロボットは，安全仕様に準拠している必要がある．
...
*iHR2024*の競技は，予め決められた手順に従って行われる．
以下のポイントに注意してください．
...
*iHR2024*では，チームは制限時間内に何度でもリスタートすることが許可されている．
...
*iHR2024*では，*優れたパフォーマンスに対するボーナス*はない．
